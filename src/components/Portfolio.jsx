    ...
    <div className="flex flex-col h-full bg-dark-800">
      ...
      <div className="px-3 py-2 border-b border-dark-500 flex items-center justify-between flex-wrap gap-2">
        <div className="flex gap-4">
          ...
          <div>
            <div className="text-xs text-gray-500">Unr. P&L</div>
      ...
      {tab === 'positions' ? (
        <div className="overflow-auto flex-1">
          {positions.length === 0 ? (
            <div className="flex items-center justify-center h-full text-gray-600 text-sm">No open positions</div>
          ) : (
            <table className="w-full text-xs">
              <thead>
                <tr className="text-gray-500 border-b border-dark-600">
                  {['Symbol','Shares','Avg Cost','Price','Value','P&L','P&L%'].map(h => (
        ...
        <div className="overflow-auto flex-1">
          {portfolio.orders.length === 0 ? (
            <div className="flex items-center justify-center h-full text-gray-600 text-sm">No trade history</div>
          ) : (
            <table className="w-full text-xs">
              <thead>
                <tr className="text-gray-500 border-b border-dark-600">
